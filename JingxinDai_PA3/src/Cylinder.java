 ...
 */
/**
 * A solid cylinder with a flat top.
 * 
...
public class Cylinder extends Circular implements Displayable {
	/**
	 ...
	 */
	public Cylinder(final double radius, final double height, final GLUT glut) {
		super(radius, glut);
		this.height = height;
	}
	
	public Cylinder(final double radius, final double height, final GLU glu) {
		super(radius, glu);
		this.height = height;
	}
	/**
	...
	public void initialize(final GL2 gl) {
		...
		this.glu().gluDisk(gluQuadric, 0,this.radius(), DEFAULT_SLICES, DEFAULT_STACKS);
