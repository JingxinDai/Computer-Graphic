 ...
 * @assignment No. PA3
 * @due 11/13/2019
 * @brief The main process of project
 */
import javax.swing.*;
...
public class PA3 extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
	...
	private boolean addFood_key = false;
	private boolean addButterfly_key= false;
	private boolean addBird_key= false;
	...
	public void display(GLAutoDrawable drawable) {
		...
		vivarium.addFood(gl,this.addFood_key);
		this.addFood_key= false;
		
		vivarium.addButterfly(gl,this.addButterfly_key);
		this.addButterfly_key= false;
		
		vivarium.addBird(gl,this.addBird_key);
		this.addBird_key= false;
	...
	public void keyTyped(KeyEvent key) {
		...
		case 'F':
		case 'f':
			this.addFood_key = true;
			break;
			
		case 'B':
		case 'b':
			this.addBird_key = true;
			break;
			
		case '>':
		case '.':
			this.addButterfly_key = true;
			break;
